...
module.exports = {
  testTimeout: 30000,
  globalSetup: "<rootDir>/src/__tests__/providers/beforeAll.test.ts",
  globalTeardown: "<rootDir>/src/__tests__/providers/afterAll.test.ts",
  ...
  // cacheDirectory: "src/__tests__/cache",
